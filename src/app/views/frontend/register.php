...
<div class="contenido">
    ...
    <div class="caja">
        ...
        <div class="form">
            ...
            <input name="username" type="text" placeholder="Nombre" id="username" required/>
            <label for="apellido" class="form"></label>
            <input name="apellido" type="text" placeholder="Apellido" id="apellido" required />
            <label for="email" class="form"></label>
            <input name="email" type="email" placeholder="Email: example@email.com" id="email" required />
            <label for="password" class="form"></label>
            <input name="password" type="password" placeholder="Contraseña" id="password" required />
            <label for="veryPassword" class="form"></label>
            <input name="veryPassword" type="password" placeholder="Repite la contraseña" id="veryPassword" required />
